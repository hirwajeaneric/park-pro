...
import UpdateWithdrawRequestDetailsForm from '@/components/forms/UpdateWithdrawRequestDetailsForm';
import WithdrawRequestFormContainers from '@/components/widget/WithdrawRequestFormContainers';
  ...
  return (
    <ProtectedRoute>
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        ...
        <WithdrawRequestFormContainers request={request} />
      </div>
    </ProtectedRoute>
  );
}